...
$(document).ready(() => {
	...
	$.ajax({
		url: `${API_START_URL}/api/Post/GetPopularPosts`,
		method: "GET",
		...
		success: function (response) {
			...
			$("#popular-post").append(
				response.map(
					(post) =>
						`<a href="./Post/tech-single.html?id=${
							post.id
...
function loadRecentPost() {
	$.ajax({
		url: `${API_START_URL}/api/Post/GetRecentPosts?page=${page}&pageSize=${pageSize}`,
		method: "GET",
		contentType: "application/json",
		success: function (response) {
